...
public class PortalWallBlockTest {
    ...
    public void testConstructor() {
        ...
        BlockAbstract constructedValidType = new PortalWallBlock(0, 0);
        assertEquals('w', constructedValidType.getType());
    ...
    //     BlockAbstract contructedValidTypeWithoutConnection = new PortalWallBlock(0, 0, 'w', null, null);
    ...
    //     ObstacleBlock connection = new PortalWallBlock(0, 0, 'w', null, null);
    //     BlockAbstract contructedValidTypeWithConnection = new PortalWallBlock(0, 0, 'w', null, connection);
    ...
    //     BlockAbstract PortalWallBlock = new PortalWallBlock(0, 0, 'w', null, null);
    //     assertTrue(PortalWallBlock.hasCollision(), "Directed blocks, and thus by extension moveable blocks, do have collision, thus hasCollision() should always return true");
    // }
    ...
    //         DirectedBlock constructedValidDirection = new PortalWallBlock(0, 0, validTypes[0], null);
    ...
    //         () -> new PortalWallBlock(0, 0, 't', null),
...
//         PortalWallBlock tpWithoutConnection = new PortalWallBlock(0, 0, null);
...
//         ObstacleBlock connection = new PortalWallBlock(0, 0, null);
//         BlockAbstract tpWithConnection = new PortalWallBlock(0, 0, connection);
...
//         private PortalWallBlock teleporter1;
//         private PortalWallBlock teleporter2;

//         @BeforeEach
//         private void setup() {
//             teleporter1 = new PortalWallBlock(0, 0, null);
//             teleporter2 = new PortalWallBlock(5, 5, null);
//         }
//         @Test
...
//             assertEquals(teleporter2, teleporter1.getConnection(), "teleporter1 should be connected to teleporter2");
//             assertEquals(teleporter1, teleporter2.getConnection(), "teleporter2 should be connected to teleporter1");
//             PortalWallBlock teleporter3 = new PortalWallBlock(0, 0, null);
...
//             BlockAbstract blockAtUpperEntry = new PortalWallBlock(tp1X, tp1Y+1, null);
//             BlockAbstract blockAtLowerEntry = new PortalWallBlock(tp1X, tp1Y-1, null);
//             BlockAbstract blockAtRightEntry = new PortalWallBlock(tp1X+1, tp1Y, null);
//             BlockAbstract blockAtLeftEntry = new PortalWallBlock(tp1X-1, tp1Y, null);
...
//             BlockAbstract enteringBlock = new PortalWallBlock(1, 1, null);
//             teleporter1.setConnection(teleporter2);
...
//             BlockAbstract enteringBlock = new PortalWallBlock(1, 0, null);
//             assertNull(teleporter1.getConnection());
...
//             int tpX = teleporter1.getX();
//             int tpY = teleporter1.getY();
//             BlockAbstract blockAtUpperEntry = new PortalWallBlock(tpX, tpY+1, null);
//             BlockAbstract blockAtLowerEntry = new PortalWallBlock(tpX, tpY-1, null);
//             BlockAbstract blockAtRightEntry = new PortalWallBlock(tpX+1, tpY, null);
//             BlockAbstract blockAtLeftEntry = new PortalWallBlock(tpX-1, tpY, null);
...
//             int tpX = teleporter1.getX();
//             int tpY = teleporter1.getY();
//             BlockAbstract blockNotAtEntryPoint = new PortalWallBlock(tpX+1, tpY+1, null);
...
//             teleporter1.setConnection(teleporter2);
//             BlockAbstract blockNotAtEntry = new PortalWallBlock(0, 0, null);
//             assertFalse(teleporter1.canBlockEnter(blockNotAtEntry));
//             BlockAbstract blockAtTeleporterCoordinates = new PortalWallBlock(0, 0, null);
//             assertFalse(teleporter1.canBlockEnter(blockAtTeleporterCoordinates));
//             BlockAbstract blockNearEntry = new PortalWallBlock(1, 1, null);
...
//             BlockAbstract block = new PortalWallBlock(1, 0, null);
...
//         PortalWallBlock teleporter = new PortalWallBlock(0, 0, null);
